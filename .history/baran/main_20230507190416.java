...
public class Main {
  public static void main(String[] args) {
    ...
    Task task = new Task(new ReadFromMemoryTask());
    taskQueue.addTask(new ReadFromMemoryTask());
    taskQueue.addTask(new WriteToMemoryTask());
    taskQueue.addTask(new ReadFromCardTask());
    taskQueue.addTask(new WriteToCardTask());
    taskQueue.execute();
  }
}